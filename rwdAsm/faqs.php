...
<html lang="en">
  ...
  <style>
    ...
    <div class="wrapper">
      ...
      <div class="faq">
        <button class="ques">
          What is MASS SPM for?
          <i class="fa-solid fa-chevron-down"></i>
        </button>
        <div class="ans">
          <p>
          This website helps SPM students revise and test their knowledge through interactive quizzes across various subjects. It’s designed for quick and effective revision.
          </p>
        </div>
      </div>
      ...
      <div class="faq">
        <button class="ques">
            Do I need to create an account to use the quizzes?
          <i class="fa-solid fa-chevron-down"></i>
        </button>
        <div class="ans">
          <p>
            Yes, you need to create an account for access the quizzes Which allow you to track your progress and save your quiz results.
          </p>
        </div>
      </div>
      ...
      <div class="faq">
        ...
        <div class="ans">
          <p>
          The quizzes consist of multiple-choice or short-answer questions based on the SPM syllabus. They are designed to be completed quickly, making them perfect for short revision sessions.
          </p>
        </div>
      </div>
      ...
      <div class="faq">
        ...
        <div class="ans">
          <p>
          Yes, you can retake any quiz as many times as you need to improve your score and reinforce your learning.
          </p>
        </div>
      </div>
      ...
      <div class="faq">
        <button class="ques">
        Is there any help or support available?
          <i class="fa-solid fa-chevron-down"></i>
        </button>
        <div class="ans">
          <p>
          Yes! If you have any questions or face any issues, you can contact our support team through the "Contact Us" page, or check out our Help section for more guidance.
          </p>
        </div>
      </div>
</section>
