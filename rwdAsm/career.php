    ...
    <div class="container">
        ...
        $job_positions = [
            [
                ...
                'requirements' => 'Bachelor\'s degree in Computer Science or related field. Experience with PHP, JavaScript, and MySQL.',
            ],
            [
                'title' => 'Project Manager',
                'requirements' => 'Proven experience in project management. Strong communication and leadership skills.',
            ],
            [
                'title' => 'UI/UX Designer',
                'requirements' => 'Experience in designing user interfaces and user experiences. Proficiency in design tools like Figma or Adobe XD.',
            ],
            [
                'title' => 'Backend Developer',
                'requirements' => 'Bachelor’s degree in Computer Science or related field. Proficiency in server-side programming languages (e.g., Node.js, Python, Ruby), experience with RESTful APIs, and strong knowledge of databases like MySQL, PostgreSQL, or MongoDB.',
            ],
            [
                'title' => 'Security Specialist',
                'requirements' => 'Bachelor’s degree in Information Security, Computer Science, or related field. Extensive experience with web security protocols, encryption methods, vulnerability assessment tools, and knowledge of OWASP top 10 security risks.',
            ],
            [
                'title' => 'Quality Assurance Tester',
                'requirements' => 'Experience with manual and automated testing tools (e.g., Selenium, TestRail), strong understanding of software testing methodologies, and ability to write test plans and perform cross-browser/device testing.',
            ]
        ];
        ...
        <div class="contact-info">
            <h3>Contact Us</h3>
            <p>If you would like to know more about any of the positions, please contact us:</p>
            <p>Email: <a href="mailto:mass_spm@gmail.com">mass_spm@gmail.com</a></p>
            <p>Phone: 05-123456</p>
        </div>
    </div>
